...
def upload_artifact(document_id:str, title: str, content: str, art_type:str, references:dict):
    """
    ...
    artifact = create_new_artifact(document_id, title, content, art_type=art_type, references=references)
