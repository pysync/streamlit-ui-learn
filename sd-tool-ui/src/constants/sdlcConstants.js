...
export const SDLC_PHASES = {
  INITIATION_PLANNING: 'initiation_planning',
...
export const PHASE_LABELS = {
  [SDLC_PHASES.INITIATION_PLANNING]: 'Initiation & Planning',
...
export const ARTIFACT_TYPE_TO_PHASE = {
  // Initiation & Planning
  [ARTIFACT_TYPES.BRAINSTORMING_NOTE]: SDLC_PHASES.INITIATION_PLANNING,
  [ARTIFACT_TYPES.PROJECT_CHARTER]: SDLC_PHASES.INITIATION_PLANNING,
  [ARTIFACT_TYPES.ROADMAP]: SDLC_PHASES.INITIATION_PLANNING,
  [ARTIFACT_TYPES.RISK_ANALYSIS]: SDLC_PHASES.INITIATION_PLANNING,
