...
import { ARTIFACT_TYPES, getArtifactTypeLabel } from '../../constants/artifactTypes';
      ...
      <DialogContent>
        <Box sx={{ display: 'flex',  pt: 1, mb: 2, gap: 2, alignItems: 'center' }}>
          ...
          <FormControl variant="outlined" size="small" sx={{ minWidth: 150 }}>
            <InputLabel id="artifact-type-filter-label">Type</InputLabel>
            <Select
              labelId="artifact-type-filter-label"
